...
import { getPermissionData, SaveDashBoardPermissions, } from "../../actions/DashboardAction/PermissionDashboardAction";
import {
  getEmployeePermissionData, getHolidayPermissionsOnValue,
...
const VerticalTabs = (props) => {
  ...
  const [attendanceApproveCheckboxPermissions, setAttendanceApproveCheckboxPermissions] =
    useState({
    ...
    if (Company && props.peopleEmpCode) {
      getEmployeePermissionData(Company, props.peopleEmpCode, (data) => {
        ...
        setAttendanceApproveCheckboxPermissions({
          CanAccessApproveAttendancePage: data?.CanAccessApproveAttendancePage || false,
          CanAccessLeaveApprovalPage: data?.CanAccessLeaveApprovalPage || false,
          CanAccessModificationApprovalPage: data.CanAccessModificationApprovalPage || false
        });
  ...
  const handleExpenseDashBoardSelection = (value) => {
    ...
    saveExpensePermissionData(Company, props.peopleEmpCode, { expenseDashboard: value });
  };
  ...
  return (
    <div className={styles.verticalTabsContainer}>
      ...
      <div className={styles.tabContent}>
        ...
        {activeTab === 2 && (
          <div>
            {/* <label style={{ display: "flex", alignItems: "center", gap: "15px", fontSize: "13px", fontFamily: "Poppins, sans-serif", cursor: 'pointer' }}>
            <input
              type="checkbox"
              value="canMarkAttendanceThorughMobile"
              checked={attendanceCheckboxPermissions.CanMarkAttendanceThorughMobile}
              onChange={handleAttendanceCheckboxChange}
            />
            Can Mark Attendnace Through Mobile
          </label> */}
        ...
        ${attendanceCheckboxPermissions.CanMarkAttendancethorughDesktop
            ...
            >
              <input
                ...
                onChange={handleAttendanceCheckboxChange}
              />
              Can Mark Attendnace Through Laptop/Desktop
            </label> */}
            <br />
          </div>
        )}
                ...
                onClick={() => {
                  handleAttendanceApproveCheckboxChange({
                    target: {
                      ...
                      checked: !attendanceApproveCheckboxPermissions.CanAccessApproveAttendancePage,
                    },
                  });
                }}
              >
        ...
        </div><div className={`${styles.toggleRow}`}>
            <div className={`${styles.toggleLeft}`}>
              <div className={`${styles.toggleText}`}>
                ...
                onClick={() => {
                  handleAttendanceApproveCheckboxChange({
                    target: {
                      ...
                      checked: !attendanceApproveCheckboxPermissions.CanAccessLeaveApprovalPage,
                    },
                  });
                }}
              >
        ...
        {activeTab === 7 && <><div className={`${styles.toggleRow}`}>
          <div className={`${styles.toggleLeft}`}>
            <div className={`${styles.toggleText}`}>
        ...
        ${departmentPermission.canAccessDepartmentPage
              ...
              onClick={() => {
                handleDepartmentCheckboxChange({
                  target: {
                    ...
                    checked: !departmentPermission.canAccessDepartmentPage,
                  },
                });
              }}
            >
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
        ${departmentPermission.canAddDepartment
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
        ${departmentPermission.canEditDepartment
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
            ${departmentPermission.canDeleteDepartment
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
            ${departmentPermission.canViewEditHistory
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
            ${departmentPermission.canAddDesignation
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
            ${departmentPermission.canEditDesignation
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
          ...
          <div className={`${styles.toggleRow}`}>
            ...
            <div className={`${styles.toggleRight}`}>
              <div
                className={`${styles.toggle} 
            ${departmentPermission.canDeleteDesignation
                    ? styles.on
                    : styles.off}`}
                onClick={() => {
                  handleDepartmentCheckboxChange({
            ...
            <div>
              <div className={`${styles.toggleRow}`}>
                ...
                <div className={`${styles.toggleRight}`}>
                  <div
                    className={`${styles.toggle} 
        ${TaskPagePermission.canAccessTaskPage
                        ? styles.on
                        : styles.off}`}
                    onClick={() => {
                    ...
                    onClick={() => {
                      handleTaskPageCheckboxChange({
                        target: {
                          ...
                          checked: !SaleFeedbackPermission.canAccessSaleFeedbackPage,
                        },
                      });
                    }}
                  >
            ...
            <div>
              <div className={`${styles.toggleRow}`}>
                ...
                <div className={`${styles.toggleRight}`}>
                  <div
                    className={`${styles.toggle} 
        ${SaleFeedbackPermission.canAddSaleFeedback
                        ? styles.on
                        : styles.off}`}
                    onClick={() => {
                      handleTaskPageCheckboxChange({
            ...
            <div className={`d-flex justify-content-center mt-4`}>
              <button className={`btn ${styles.btnAdd}`} onClick={handlePopUpOpen}>+ Add State Permission</button>
            </div>


            {activePopUp && (
              <StatePermissionsPopUP setActivePopUp={setActivePopUp} activePopUp={activePopUp} />
            )}
          </>
        }
        {activeTab === 15 && (
