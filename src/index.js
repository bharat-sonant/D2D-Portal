...
const AppWrapper = () => {
  ...
  const noFrameRoutes = ['/settings', '/tasks', '/realtime-monitoring', '/reports', '/vehicle', '/users', '/', '/cities', "/Dashboard", "/monitoring","/employee/dashboard","/employee/employees","/employee/branches","/employee/departments", '/fuel/add-field-employee', '/fuel/fuel_analysis',"/fe-WebView/login","/fe-WebView/dashboard", "/fuel/add_fuel_entries","/field-executive/dashboard","/field-executive/employees","/field-executive/tracking","/field-executive/reports","/field-executive/tasks","/field-executive/analysis"]; // <-- yaha route add karo
