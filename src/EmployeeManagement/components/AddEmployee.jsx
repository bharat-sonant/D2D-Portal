...
const AddEmployee = ({
        ...
        if (showCanvas) {
            ...
            if (employeeToEdit) {
                setForm({
                    ...
                    created_by: employeeToEdit.created_by
                });
            } else {
                setForm({
                    employee_name: "",
    ...
    const handleSave = () => {
        validateEmployeeDetail({
            ...
            onSuccess: (message) => {
                setLoading(false);
                // Dispatch success to parent to avoid double toast
                if (onRefresh) onRefresh(employeeToEdit ? "Employee updated successfully" : "Employee added successfully");
                setShowCanvas(false);
            },
            onError: (error) => {
                setLoading(false);
                common.setAlertMessage("error", error || "An unexpected error occurred");
            },
        });
    };

    const helperStyle = { fontSize: "11px", color: "var(--textMuted)", marginTop: "4px", display: "block" };
                ...
                <div className={modalStyles.modalBody} style={{ padding: "24px" }}>
                    ...
                    >
                        ...
                        <div className={modalStyles.inputGroup}>
                            ...
                            {nameError ? <ErrorMessage message={nameError} /> : <span style={helperStyle}>Full legal name of the employee.</span>}
                        </div>
                        ...
                        <div className={modalStyles.inputGroup}>
                            ...
                            <div className={modalStyles.inputWrapper}>
                                ...
                                <input
                                    ...
                                    style={employeeToEdit ? { background: "#f1f5f9", cursor: "not-allowed" } : {}}
                                    autoComplete="off"
                                />
                            </div>
                            {empCodeError ? <ErrorMessage message={empCodeError} /> : <span style={helperStyle}>Unique ID assigned to the employee.</span>}
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className={modalStyles.inputGroup}>
                            ...
                            {phoneError ? <ErrorMessage message={phoneError} /> : <span style={helperStyle}>10-digit mobile number for communication.</span>}
                        </div>
                        ...
                        <div className={modalStyles.inputGroup}>
                            ...
                            {emailError ? <ErrorMessage message={emailError} /> : <span style={helperStyle}>Official contact email (if exists).</span>}
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className={modalStyles.inputGroup}>
                            ...
                            {branchError ? <ErrorMessage message={branchError} /> : <span style={helperStyle}>The primary branch this employee belongs to.</span>}
                        </div>
