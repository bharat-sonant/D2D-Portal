                    ...
                    <>
                        ...
                        <div className={styles.layoutSplit}>
                            ...
                            <div className={styles.leftColumn}>
                                ...
                                {/* Live Field Insights - Below Profiles */}
                                <div className={styles.glassCard}>
                                    <div
                            ...
                            <div className={styles.rightColumn}>
                                ...
                                <div className={styles.statusRow}>
                                    ...
                                    <StatusCard
                                        ...
                                        subtext="Optimal Path"
                                        icon={<Activity size={20} />}
                                    />
                                    <StatusCard
                                        label="Sync Activity"
                                        value={wardData.appStatus}
                                        subtext="Terminal Connected"
                                        icon={<Zap size={20} />}
...
const StatusCard = ({
    ...
    <div className={styles.statusCard} onClick={onClick}>
        ...
        <div className={styles.statusSubtext}>{subtext}</div>
    </div>
);
