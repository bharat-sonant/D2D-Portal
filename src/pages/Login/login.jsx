...
export default function Login() {
 ...
 let loginStatus =  localStorage.getItem('isLogin')
  ...
  const handleSubmit = async (e) => {
    ...
    // if (empCode && password) {
    //   alert('Login successful! Welcome to Office Management.');
    // } else {
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center" 
      ...
      <div className="container">
        <div className="row bg-white rounded-4 shadow-lg overflow-hidden" style={{ maxWidth: '1100px', margin: '0 auto' }}>
          
          {/* Left Section */}
          <div className="col-lg-6 d-flex flex-column align-items-center justify-content-center text-white p-5"
               style={{
            ...
            <p className="text-center" style={{ opacity: 0.9, maxWidth: '400px' }}>
              “Door-to-door waste collection” refers to a system where waste is collected directly from households, individuals to take their waste to a central dumping site. It’s commonly used in urban sanitation programs to manage municipal solid waste efficiently.
            </p>
          </div>
          ...
          <div className="col-lg-6 p-5 d-flex flex-column justify-content-center">
            ...
            <div>
              {/* Employee Code */}
              <div className="mb-3">
                <label className="form-label text-uppercase text-muted" 
