...
const MonitoringList = () => {
  ...
  const currentShiftEvents = [
    { key: "dutyOn", label: "Duty On", time: wardData.dutyOn, status: "completed" },
    { key: "reachOn", label: "Reached", time: wardData.reachOn, status: "completed" },
                ...
                <div className={styles.mapColumn}>
                  <div className={`${styles.glassCard} ${styles.mapCard}`}>
                    ...
                    <div className={styles.mapFooter}>
                      <div className={styles.mapStat}><UsersIcon size={14} color="var(--themeColor)" /> <span>Heroes: <b>{wardData.heroesOnWork}</b></span></div>
                      <div className={styles.mapStat}><Truck size={14} color="var(--themeColor)" /> <span>Garage: <b>{wardData.garageDuty}</b></span></div>
                    </div>
                  </div>
