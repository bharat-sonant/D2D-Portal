              ...
              {showVehicleModal ? (
                ...
                <div className={styles.remarkFormWrap}>
                  ...
                  >
                    <button
                      type="button"
                      className={`${styles.customDropdownToggle} ${showTopicDropdown ? styles.customDropdownToggleOpen : ""
                        }`}
                      onClick={() => setShowTopicDropdown((prev) => !prev)}
                    >
                      <span
                        className={`${styles.customDropdownText} ${!remarkForm.topic ? styles.customDropdownPlaceholder : ""
                          }`}
                      >
                      ...
                      <ChevronRight
                        size={16}
                        className={`${styles.customDropdownCaret} ${showTopicDropdown ? styles.customDropdownCaretOpen : ""
                          }`}
                      />
                    </button>
                    {showTopicDropdown && (
                      <div className={styles.customDropdownMenu}>
                        {remarkTopicOptions.map((item) => (
                          <button
                            key={item}
                            type="button"
                            className={`${styles.customDropdownItem} ${remarkForm.topic === item
