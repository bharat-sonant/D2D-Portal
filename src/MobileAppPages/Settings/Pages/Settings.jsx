...
import { getBackOfficeSettingKey } from "../Action/BackOffice/BackOfficeAction.js";
import {
  getDailyAssignmentKey,
  getWebViewUrl,
} from "../Action/DailyAssignment/DailyAssignment.js";
import { getPenaltiesKey } from "../Action/Penalties/PenaltiesAction.js";
import { getWorkMonitoringKey } from "../Action/WorkMonitoring/WorkMonitoringAction.js";
import DailyAssignmentToggle from "../Component/DailyAssignment/DailyAssignmentToggle.jsx";
  ...
  return (
    <div className={style.verticalContainer}>
      <div className={style.verticalTabs}>
        <div
          className={`${style.tabItem} ${activeTab === "backoffice" ? style.activeTab : ""}`}
          onClick={() => setActiveTab("backoffice")}
        >
          BackOffice Settings
        </div>
        <div
          className={`${style.tabItem} ${activeTab === "report" ? style.activeTab : ""}`}
          onClick={() => setActiveTab("report")}
        >
          Duty On/Off Report
        </div>
        <div
          className={`${style.tabItem} ${activeTab === "navigator" ? style.activeTab : ""}`}
